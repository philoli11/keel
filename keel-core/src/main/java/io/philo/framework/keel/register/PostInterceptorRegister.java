 ...
 */
@Component
public class PostInterceptorRegister implements Register<CommandInterceptor> {

    @Resource
    private CommandHub commandHub;

    public void doRegistration(ApplicationContext applicationContext) {
        List<CommandInterceptor> commandInterceptors = scan(applicationContext, PostInterceptor.class);
